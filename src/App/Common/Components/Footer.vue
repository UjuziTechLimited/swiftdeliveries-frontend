...
<template>
    ...
    <footer class="p-10 rounded footer footer-center bg-base-200 text-base-content">
        <nav class="grid grid-flow-col gap-4">
            ...
            <a href="https://ujuzitech.com" class="link link-hover">UjuziTech</a>
        </nav>
        <nav>
            <div class="grid grid-flow-col gap-4">
                <a href="https://www.linkedin.com/company/ujuzitech-limited/"><svg xmlns="http://www.w3.org/2000/svg"
                ...
                <a href="https://github.com/UjuziTechLimited">
                ...
                <a href="https://twitter.com/ujuzitech/">
                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="48" height="48" viewBox="0 0 48 48">
                        <path fill="#03A9F4"
        ...
        <aside>
            <p>© 2024 UjuziTech Ltd - All Rights Reserved</p>
        </aside>
    </footer>
</template>
